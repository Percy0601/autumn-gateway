...
rm -rf ~/.m2/repository/org/springframework/cloud/spring-cloud-context/5.0.3
rm -rf ~/.m2/repository/org/springframework/cloud/spring-cloud-commons/5.0.3
...
### 3. 强刷重拉 + 重编
```
mvn -U -DskipTests -Pnative native:compile
```
